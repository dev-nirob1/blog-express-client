...
const EditorsPick = () => {
    return (
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:items-center p-5 border md:border-0 my-8">
                <div className="relative h-full w-full">
                    <img src="/banner.jpg" className="h-full w-full" alt="title image" />
