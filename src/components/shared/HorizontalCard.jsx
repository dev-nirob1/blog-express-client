    ...
    return (
        <div className="w-full h-[60vh] mb-8 px-1">
            <div className="w-full h-full relative rounded-lg">
                ...
                <div className="w-full h-full absolute bottom-0 left-0 flex items-end justify-center text-center bg-gradient-to-b from-slate-500/40 to-black/50 rounded-lg">
                    <div className="absolute left-5 top-5">
                        <p className="rounded-full font-serif px-2 text-gray-50 bg-blue-600">
                            {blog?.category}
                        </p>
                    </div>
                    <Link to={`/blog/${blog?._id}`} className="text-gray-100 font-semibold p-10 space-y-3">
